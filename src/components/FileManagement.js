      ...
      render: (_, record) => {
        return (
          <a
            onClick={() =>
              window.open(
                "https://bndhqt.phuckhangnet.vn/ftp_storage/" +
                  record.filename +
                  "." +
                  record.fileextension.split("/")[1]
              )
            }
          >
            https://bndhqt.phuckhangnet.vn/ftp_storage/{record.filename}.
            {record.fileextension.split("/")[1]}
          </a>
        );
      },
  ...
  return (
    <>
      ...
      <div className="modalUpload">
        <Modal
          title={<h5 className="text-secondary">Tải hình ảnh lên thư viện</h5>}
          centered
          visible={visible}
          width={"100%"}
