...
const Login = () => {
  ...
  async function checkRole() {
    ...
    if (
      ...
      if (result.responses.role.indexOf(",") > -1) {
        ...
        sessionStorage.setItem("pageVNAvailable", result.responses.status);
        sessionStorage.setItem("pageENAvailable", result.responses.status);
  ...
  return (
    ...
    >
      ...
      <Image
        width={150}
        src={"https://bndhqt.phuckhangnet.vn/config/logo.png"}
      />
      <Form
        name="normal_login"
